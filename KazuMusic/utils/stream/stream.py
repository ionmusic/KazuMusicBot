...
import config
from KazuMusic import Carbon, YouTube, app
from KazuMusic.core.call import Kazu
from KazuMusic.misc import db
from KazuMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from KazuMusic.utils.exceptions import AssistantErr
from KazuMusic.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from KazuMusic.utils.inline.playlist import close_markup
from KazuMusic.utils.pastebin import Kazubin
from KazuMusic.utils.stream.queue import put_queue, put_queue_index
from KazuMusic.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Kazu.force_stop_stream(chat_id)
