...
from KazuMusic import Telegram, YouTube, app
from KazuMusic.misc import SUDOERS, _boot_
from KazuMusic.plugins.playlist import del_plist_msg
from KazuMusic.plugins.sudoers import sudoers_list
from KazuMusic.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from KazuMusic.utils.decorators.language import LanguageStart
from KazuMusic.utils.formatters import get_readable_time
from KazuMusic.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/KazuSupportGrp) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
